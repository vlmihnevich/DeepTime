...
const UI: Record<string, UIStrings> = {
  en: {
    ...
    annotation: 'All of <strong>recorded human history</strong> (~5,000 years) occupies the last <strong>0.00011%</strong> of Earth\'s story — invisible at this scale.<br><span class="ann-clock">The timeline below maps 4.54 billion years onto a <strong>24-hour clock</strong>. Humans appear at <strong>23:59:59</strong>.</span><br><span class="ann-hint">Scroll to zoom in</span>',
  ...
  ru: {
    ...
    annotation: 'Вся <strong>письменная история человечества</strong> (~5 000 лет) занимает лишь <strong>0,00011%</strong> истории Земли — невидимая на этом масштабе.<br><span class="ann-clock">Шкала ниже сжимает 4,54 млрд лет в <strong>24 часа</strong>. Человек появляется в <strong>23:59:59</strong>.</span><br><span class="ann-hint">Прокрутите для увеличения</span>',
